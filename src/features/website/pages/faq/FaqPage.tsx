        ...
        <div className="max-w-[600px] mx-auto mt-12 md:mt-16">
          <div className="bg-white rounded-2xl p-8 md:p-10 text-center shadow-lg border border-primary-500/10">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center flex-wrap">
              ...
              <a
                href={FAQ_SUPPORT_LINKS.whatsappHref}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-[#25D366] px-6 py-2.5 text-sm font-semibold text-[#25D366] transition-all hover:bg-[#25D366] hover:text-white"
              >
