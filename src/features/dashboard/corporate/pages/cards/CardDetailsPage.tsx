...
import { useCorporateCardDetailsPage } from './useCorporateCardDetailsPage'

export default function CorporateCardDetailsPage() {
  const {
    cardType,
    validCardType,
    navigate,
    ...
    return (
      <div className="w-full">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
          ...
          <Button
            variant="primary"
            onClick={() => navigate(addAccountParam(ROUTES.IN_APP.DASHBOARD.CORPORATE.HOME))}
          >
            Back to Dashboard
          </Button>
        </div>
  ...
  return (
    <div className="w-full">
          ...
          <div className="px-6 pb-6">
            ...
            <div className="mb-4">
              ...
              {!selectedVendor ? (
                ...
                <div className="p-4 bg-linear-to-br from-green-50 to-emerald-50 border border-green-200 rounded-xl">
                ...
                <Combobox
                  ...
                  onChange={(e: { target?: { value?: string } }) => {
                    ...
                    if (branchId !== undefined) {
                      setSelectedBranchIdFromValue(branchId || '')
                    }
                  }}
      ...
      >
        {selectedCard && (
          <div className="px-6 pb-6">
            <div className="bg-linear-to-br from-[#FF8A00] to-[#FF6B00] rounded-xl p-6 mb-6 text-white">
