                      ...
                      >
                        <div className="flex justify-between items-center mb-2">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="w-10 h-10 rounded-full bg-linear-to-br from-[#402D87] to-[#2d1a72] flex items-center justify-center text-white text-sm font-bold">
                        ...
                        <div className="w-full bg-[#e9ecef] rounded-full h-2 mt-2">
                          <div
                            className="bg-linear-to-r from-[#402D87] to-[#2d1a72] h-2 rounded-full transition-all duration-500"
